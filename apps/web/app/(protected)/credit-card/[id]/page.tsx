...
export default function CreditCardDetailsPage() {
  ...
  const handlePreviousMonth = () => {
    ...
    if (selectedMonth === undefined || selectedYear === undefined) {
      ...
      const prevMonth =
        billDate.getMonth() === 0 ? 11 : billDate.getMonth() - 1;
      const prevYear =
        billDate.getMonth() === 0
  ...
  const handleNextMonth = () => {
    ...
    if (selectedMonth === undefined || selectedYear === undefined) {
      ...
      const billDate = new Date(invoiceData.billStartDate);
      const nextMonth =
        billDate.getMonth() === 11 ? 0 : billDate.getMonth() + 1;
      const nextYear =
        billDate.getMonth() === 11
          ? billDate.getFullYear() + 1
          : billDate.getFullYear();
  ...
  const handleUnpayInvoice = async () => {
    ...
    try {
      ...
      setEditError(
        err instanceof Error ? err.message : "Failed to unpay invoice",
      );
    } finally {
            ...
            <div className="flex items-center gap-5 mt-4 flex-wrap">
              <div>
                ...
                <div className="text-base font-bold">
                  {formatCurrency(
                    Math.max(0, invoiceAmount),
                    invoiceData.card.currency,
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="text-sm font-semibold">
                  {new Date(billStartDate).toLocaleDateString("en-US", {
                    month: "short",
                    day: "numeric",
                  })}{" "}
                  –{" "}
                  {new Date(billEndDate).toLocaleDateString("en-US", {
                    month: "short",
                    day: "numeric",
                  })}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 mt-5">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-5">
            <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-4">
              ...
              <div
                className={`text-lg font-bold ${previousBalance < 0 ? "text-emerald-600" : "text-red-600"}`}
              >
            ...
            <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-4">
              ...
              <div className="text-lg font-bold text-red-600">
                {formatCurrency(monthSpending, invoiceData.card.currency)}
              </div>
            </div>
            <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-4 col-span-2 md:col-span-1">
              ...
              <div
                className={`text-lg font-bold ${invoiceAmount <= 0 ? "text-emerald-600" : "text-red-600"}`}
              >
              ...
              <div className="flex items-center gap-3 text-green-800">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-green-700">
                    ...
                    that will be applied to future invoices.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-4 p-4 bg-green-50 border-2 border-green-300 rounded-lg shadow-sm">
              <div className="flex items-center justify-between flex-wrap gap-3">
                <div className="flex items-center gap-2 text-green-800 font-bold text-base">
                  ...
                  <span>
                    Fully Paid
                    {invoiceData.invoice.paidAt &&
                      ` on ${new Date(invoiceData.invoice.paidAt).toLocaleDateString("en-US", { month: "short", day: "numeric" })}`}
                  </span>
                </div>
          ...
          {invoiceData.invoice &&
            invoiceData.invoice.paidAmount > 0 &&
            !invoiceData.invoice.isPaid && (
                ...
                <div className="text-sm text-blue-900 space-y-3">
                  <div className="flex items-center justify-between pb-2 border-b border-blue-200">
                    ...
                    <span className="font-bold text-green-700 text-base">
                      {formatCurrency(
                        invoiceData.invoice.paidAmount,
                        invoiceData.card.currency,
                      )}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-bold text-red-700 text-base">
                      {formatCurrency(
                        Math.max(
                          0,
                          invoiceAmount - invoiceData.invoice.paidAmount,
                        ),
                        invoiceData.card.currency,
                      )}
                    </span>
            ...
            <div className="mb-4 p-4 bg-blue-50 border-2 border-blue-300 rounded-lg shadow-sm">
              <div className="flex items-center justify-between flex-wrap gap-2">
                ...
                <div className="text-sm font-bold">
                  Total:{" "}
                  <span
                    className={`text-base ${filteredTotal < 0 ? "text-green-700" : "text-red-700"}`}
                  >
                    {formatCurrency(
                              ...
                              <div className="flex items-center gap-3 flex-1 min-w-0">
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  <div className="flex items-center gap-2 flex-wrap">
                                    ...
                                    <div
                                      className={`text-sm font-bold ${isIncome ? "text-green-700" : "text-red-700"}`}
                                    >
                                      {isIncome ? "+" : ""}
                                      {formatCurrency(
        ...
        <DialogContent className="max-w-md">
            ...
            <div className="space-y-4">
              <div className="p-5 bg-gray-50 border-2 border-gray-200 rounded-lg">
                ...
                <div className="text-sm text-gray-600 font-medium">
                  Billing Period: {formatDate(invoiceData.billStartDate)} -{" "}
                  {formatDate(invoiceData.billEndDate)}
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-700 font-semibold text-lg">
                    $
                  </span>
                  <input
                    id="payment-amount"
                ...
                parseFloat(
                  ...
                  <div className="p-4 bg-blue-50 border-2 border-blue-300 rounded-lg">
                    <p className="text-sm text-blue-900 font-medium">
                      <strong className="font-bold">Partial Payment:</strong>{" "}
                      After paying{" "}
                      {formatCurrency(
                        parseFloat(paymentAmount),
                        invoiceData.card.currency,
          ...
          <DialogFooter className="gap-2">
            ...
            <Button
              ...
              disabled={
                paymentLoading || !selectedBankAccountId || !paymentAmount
              }
      ...
      <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              You can change the bank account used for payment or mark the
              invoice as unpaid.
            </DialogDescription>
          </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm text-gray-700 font-medium text-center">
                  Change payment source (coming soon)
                </p>
              </div>
              ...
              {invoiceData.invoice?.isPaid && (
                <div className="p-4 bg-yellow-50 border-2 border-yellow-300 rounded-lg">
                  <p className="text-sm text-yellow-900 font-semibold mb-2">
                    <strong className="font-bold">Note:</strong> This invoice
                    has been paid. Deleting it will reverse the payment
                    transaction:
                  </p>
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              cannot be undone and will update your credit card balance.
            </DialogDescription>
          </DialogHeader>
