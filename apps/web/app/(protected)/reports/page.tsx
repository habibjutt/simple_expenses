...
import { ChevronLeft, ChevronRight, TrendingUp, TrendingDown, PieChart as PieIcon, Target, Download } from "lucide-react";
...
export default function ReportsPage() {
  ...
  const handleExportReportCsv = async () => {
    try {
      ...
      const res = await fetch(`/api/v1/reports/export?${params}`, { credentials: "include" });
      if (res.status === 401) {
        router.push("/login");
        return;
      }
