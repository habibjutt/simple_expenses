        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14 sm:py-20">
          <div className="mb-10 space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Simple Expenses (&quot;we&quot;, &quot;our&quot;, or &quot;the Service&quot;) is committed to
              protecting your personal data. This Privacy Policy explains how we
              collect, use, store, and protect information in accordance with
              the{" "}
          ...
          <div className="space-y-10 border-t border-border pt-10">
            <Section title="1. Information We Collect">
              ...
              <ul className="list-disc pl-5 space-y-1">
                ...
                <li>
                  <strong className="text-foreground">Financial data:</strong> Credit card details
                  (names, limits, bill dates — not card numbers), bank account
                  balances, and transactions you manually enter.
                </li>
                <li>
                  <strong className="text-foreground">Usage data:</strong> Pages visited, features used,
                  and interactions within the app — collected to improve the
                  Service.
                </li>
                <li>
                  <strong className="text-foreground">Technical data:</strong> IP address, browser type,
                  device information, and cookies for session management.
                </li>
              </ul>
              <p>
                We do <strong className="text-foreground">not</strong> collect actual bank card numbers,
                CVVs, PINs, or connect to your bank accounts directly. All
                financial data is entered manually by you.
              </p>
            </Section>
            ...
            <Section title="2. How We Use Your Data">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>Provide, operate, and maintain the Simple Expenses Service.</li>
                <li>Personalise your dashboard, reports, and notifications.</li>
                <li>Send service-related emails (password resets, billing alerts).</li>
                <li>Improve and develop new features based on aggregated, anonymised usage data.</li>
              ...
              <p>
                ...
                or financial data with third parties for marketing purposes.
              </p>
            </Section>
            ...
            <Section title="3. Data Storage and Security">
              <p>
                ...
                <strong className="text-foreground">UAE or EU regions</strong> with industry-standard
                security measures:
              </p>
              <ul className="list-disc pl-5 space-y-1">
            ...
            <Section title="4. Data Sharing">
              ...
              <ul className="list-disc pl-5 space-y-1">
                <li>
                  <strong className="text-foreground">Service providers:</strong> Trusted sub-processors
                  (database hosting, email delivery) under strict data processing
                  agreements.
                </li>
                <li>
                  <strong className="text-foreground">Legal requirements:</strong> When required by UAE
            ...
            <Section title="5. Your Rights Under UAE PDPL">
              ...
              <p>
                ...
                <a href="mailto:privacy@simpleexpenses.ae" className="text-primary hover:underline">
            ...
            <Section title="6. Cookies">
              <p>
                We use cookies strictly for authentication session management and
                security purposes. We do not use tracking or advertising cookies.
            ...
            <Section title="7. Data Retention">
              <p>
                ...
                aggregate data (totals, statistics) may be retained indefinitely.
              </p>
            </Section>
            ...
            <Section title="9. Changes to This Policy">
              <p>
                ...
                you by email and through an in-app notice at least 14 days before
                material changes take effect. Your continued use of the Service
