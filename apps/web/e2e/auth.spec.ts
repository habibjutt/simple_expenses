...
test.describe("Login", () => {
  ...
  test("empty fields prevent submission (browser validation)", async ({
    page,
  }) => {
    await page.getByRole("button", { name: "Login" }).click();
...
test.describe("Admin Access", () => {
  ...
  test("non-admin user visiting /admin is redirected to /dashboard", async ({
    page,
  }) => {
...
test.describe("Forgot Password", () => {
  ...
  test("unknown email shows same confirmation (no user enumeration)", async ({
    page,
  }) => {
