        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 mt-5 space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1a9e5c]"
                >
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-2xl p-10 text-center shadow-sm border border-slate-200/60">
              ...
              <p className="text-sm text-slate-500">No spending limits set for {monthLabel}</p>
              <button onClick={() => setShowAdd(true)} className="mt-3 text-sm text-[#1a9e5c] font-semibold hover:underline">
