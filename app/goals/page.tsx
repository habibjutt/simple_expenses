        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 mt-5">
          {loading ? (
            ...
            <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-slate-200/60">
              <div className="w-16 h-16 bg-[#1a9e5c]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <PiggyBank className="h-8 w-8 text-[#1a9e5c]" />
              </div>
              <h3 className="font-semibold text-slate-800 mb-1">No goals yet</h3>
              <p className="text-sm text-slate-400 mb-5">Create a savings goal to start tracking your progress</p>
              <button
                onClick={openCreate}
                className="inline-flex items-center gap-2 bg-[#1a9e5c] text-white px-5 py-2.5 rounded-xl text-sm font-semibold hover:bg-[#158a4f] transition-colors"
              >
                <Plus className="h-4 w-4" />
